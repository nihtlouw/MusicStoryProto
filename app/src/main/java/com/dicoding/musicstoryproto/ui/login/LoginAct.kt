...
import com.dicoding.musicstoryproto.customview.CustNotif
import com.dicoding.musicstoryproto.data.Result
import com.dicoding.musicstoryproto.ui.register.RegisterAct
import com.dicoding.musicstoryproto.databinding.ActivityLoginBinding
import com.dicoding.musicstoryproto.response.LoginModel
import com.dicoding.musicstoryproto.response.LoginResponse
import com.dicoding.musicstoryproto.preference.LoginPreference
import com.dicoding.musicstoryproto.ui.mainmenu.MainAct
import com.dicoding.musicstoryproto.utils.FactoryVM
import com.dicoding.musicstoryproto.utils.isValidEmail
...
class LoginAct : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null) {
            binding.loginLayout.emailEditText.setText(savedInstanceState.getString("email"))
            binding.loginLayout.passwordEditText.setText(savedInstanceState.getString("password"))
        }
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        outState.putString("email", binding.loginLayout.emailEditText.text.toString())
        outState.putString("password", binding.loginLayout.passwordEditText.text.toString())
